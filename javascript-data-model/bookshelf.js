...
console.log('The author of the book ' + bookshelf[1].title + ' is ' + bookshelf[1].author);
console.log('ISBN of ' + bookshelf[0].title + ' is: ' + bookshelf[0].isbn);
console.log('Third book is: ' + bookshelf[2].title + '.');
